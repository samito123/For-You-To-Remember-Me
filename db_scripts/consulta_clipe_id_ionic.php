<?php
  ...
  try{
    ...
    $sql1="update tb_clips as tc1, 
      (select visualizacoes_clip from tb_clips where id_clip = $id_clip) as tc2 
      set tc1.visualizacoes_clip = tc2.visualizacoes_clip + 1
    ...
    $sql2="select id_clip, link_clip, img_clip, 
     ...
     from tb_clips 
     left join tb_mensagens on id_clip = fk_clip
     where id_clip = $id_clip 
     group by id_clip";
